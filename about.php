...
<noscript>
  ...
  <p style="float:right;"><small>Credit to <a href="http://kippt.com/jasondavis" target="_blank">Jason Davis</a> for <a href="http://kippt.com/jasondavis/twitter-bootstrap/clips/10194153" target="_blank">Bootstrap Captcha</a></small></p>
    ...
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Pastel Stream Bootstrap Theme | PrepBootstrap</title>
    <meta name="description" content="Pastel Stream Theme by PrepBootstrap - This is a custom Bootstrap theme with a palette of pastel warm colors" />
    <link rel="stylesheet" type="text/css" href="css/pastel-stream.css" />
    <script type="text/javascript" src="js/jquery-1.10.2.min.js"></script>
...
<div id="this-carousel-id" class="carousel slide"><!-- class of slide for animation -->
  ...
  <div class="carousel-inner">
    <div class="item active"><!-- class of active since it's the first item -->
     ...
     <a href="http://phycolab.ua.edu" target="_blank">http://phycolab.ua.edu</a></p>
      </div>
    </div>
    <div class="item">
    ...
    <div class="item">
     ...
     <p>University of Alabama<br />
     GitHub Project: <a href="https://github.com/rtkarcher/etech-wordpress-dashboard-widget" target="_blank">https://github.com/rtkarcher/etech-wordpress-dashboard-widget</a></p>
      </div>
    </div>
  </div><!-- /.carousel-inner -->
